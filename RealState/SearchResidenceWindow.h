...
struct SearchInfo
{
	...
	Type type = Type::None;
	int max_baseprice = 0, min_buildarea = 0, min_apartments = 0, same_buildarea = 0, min_rooms = 0;
	string street;
...
private:
	...
	QSpinBox *max_basepriceEdit, *min_buildareaEdit, *min_apartmentsEdit, *same_buildareaEdit, *min_roomsEdit;
